  ...
  e = Entry(root, width=15, borderwidth=4, relief=FLAT,fg= '#FFFFFF', bg='a7a28f'' front=('futura', 25, 'bold')), justify=CENTER)
  e.grid(
    row=0
    column=0
    columnspan=4
  ...
  multiplica  = Button(root,
                  ...
                  padx=40
                  pady=20
                  command=lambda: botao_multiplicao,
                  fg='#FFFFFF',
                  activeforeground='#FFFFFF',
                  bg='#320064',
                  activebackground='#240046',
  ...
  menos  = Button(root,
                  ...
                  padx=40
                  pady=20
                  command=lambda: botao_subtracao,
                  fg='#FFFFFF',
                  activeforeground='#FFFFFF',
                  bg='#320064',
                  activebackground='#240046',
  ...
  zero.grid(row=4, column=1, coumnspan=2)
  limpa = Button(root,
                  text='c',
                  padx=40
                  pady=20
